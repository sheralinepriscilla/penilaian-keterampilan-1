...
console.log ("Luas Seimut Gelas      = " + gelas.luasSelimut() + "cm2");
console.log ("---------------------------");
console.log ("  ");
...
console.log ("Volume Traffic Cone      = " + cone.volume() + "cm3");
console.log ("Luas Permukaan Traffic Cone      = " + cone.luasPermukaan() + "cm2");
console.log ("Luas Seimut Traffic Cone      = " + cone.luasSelimut() + "cm2");
console.log ("---------------------------");
console.log ("  ")
